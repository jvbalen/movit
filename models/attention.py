"""
Simple binary output transformer by Peter Bloem
...
class CTransformer(nn.Module):
    ...
    - skips the token embedding layer, inputs are assumed dense
    - returns logits of size bs x n_out (instead of log_softmax)
    """

    def __init__(self, emb, heads, depth, seq_length, n_out, max_pool=True, dropout=0.0, wide=False):
        """
        ...
        self.to_logits = nn.Linear(emb, n_out)
